...
class Trigon {
  ...
  constructor(sideA, sideB, hypotenuse) {if(typeof sideA !== 'number' || typeof sideB !== 'number' || typeof hypotenuse !== 'number' ) {
    throw new Error("Arguments are not a number");
  }
  if(sideA <= 0 || sideB <= 0 || hypotenuse <= 0) {
    throw new Error ("Arguments are not correct");
...
function calcAmountBits(numberInput) {
  ...
  typesBit.bitZero = 32 - typesBit.bitOne;
...
function switchBit(inputNumber) {
  if(typeof inputNumber !== 'number') {throw new Error("Argument is not number");
}
